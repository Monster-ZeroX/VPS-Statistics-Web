...
cd /var/www/html/
wget https://github.com/Monster-ZeroX/VPS-Statistics-Web/archive/refs/heads/main.zip
unzip main.zip
rm -R main.zip
...
chmod -R 777 *
clear
echo "${yellow}VPS Statistics Web Successfully Installed ${red}(Script By Monster ZeroX)"
